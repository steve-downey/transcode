...
// Negative compile test: iconv_transcode_or_error iterator must be move-only.
...
static_assert(std::copy_constructible<iter_t>, "transcode: iconv_transcode_or_error iterator is move-only");
